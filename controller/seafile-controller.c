...
read_seafdav_config()
{
    ...
    if (error != NULL) {
        seaf_message ("Error when reading seafdav.enabled, use deafult value 'false'\n");
    ...
    if (error != NULL) {
        seaf_message ("Error when reading seafdav.fastcgi, use deafult value 'false'\n");
    ...
    if (error != NULL) {
        seaf_message ("Error when reading seafdav.port, use deafult value 8080\n");
